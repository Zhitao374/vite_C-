...
|---|---|---|---|---|---|
| 01 | 初识 C++ | 程序 = 指令 + 数据 | ✅ 已完成 | 30 | 0 |
| 02 | 变量与整数类型 | 变量 = 有类型的盒子 | ✅ 已完成 | 30 | 0 |
| 03 | 小数、字符、布尔与类型转换 | 不同类型住不同的家 | ✅ 已完成 | 30 | 0 |
| 04 | 运算符与分支 | 运算符 = 工具，分支 = 岔路口 | ✅ 已完成 | 30 | 0 |
| 05 | 循环结构 | 循环 = 转圈 | ✅ 已完成 | 30 | 1 evolution |
| 06 | 一维数组 | 数组 = 储物柜 | ✅ 已完成 | 29 | 1 evolution |
| 07 | 字符串基础 | 字符串 = 文字项链 | ✅ 已完成 | 30 | 0 |
| 08 | 函数 | 函数 = 料理机 | ✅ 已完成 | 30 | 1 function-call + 1 evolution |
